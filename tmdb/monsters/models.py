...
class Monster(models.Model):
    ...
    avg_weight = models.DecimalField(null=True, blank=True, max_digits=6, decimal_places=2)
    avg_height = models.DecimalField(null=True, blank=True, max_digits=4, decimal_places=2)
