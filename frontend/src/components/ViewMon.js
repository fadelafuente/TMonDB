...
import { useDeleteResource, useGetResourceById, useMiddleViewPort } from '../hooks/hooks';
...
function ViewMon({ isAuthenticated }) {
    const { query } = useOutletContext();
     const [monster, _] = useGetResourceById('monsters');
                    ...
                    :
                        <div>
                            ...
                            <div className='comments-container article-container'>
                                <PostArticles query={ null } kwargs={ { parent: monster.article ? monster.article.id : null } } />
                            </div>
                        </div>
            :
                <LoadingCard />
