...
import { useCreateResource, useDiscardModal, useHeightConversions, useWeightConversions } from '../../hooks/hooks';
...
export default function CreateMon({action='create'}) {
   ...
   const worlds = ['Pokemon', 'Temtem', 'Nexomon']
    ...
    const [chosenHeightFt, setChosenHeightFt, 
        chosenHeightIn, setChosenHeightIn, setChosenHeightCm] = useHeightConversions('', '');
    ...
    const { name, national_id, species, description, etymology, avg_weight, avg_height } = formData;
            ...
            <div className='article-container'>
                <Form>
                                ...
                                <div className='row-to-col-container'>
                                    ...
                                    <InputGroup>
                                        <FormControl
                                            ...
                                            value={ avg_height }
                                            name='avg_height'
                                            onChange={ (e) => setChosenHeightCm(e, (d) => resetFormData(d)) }
                                        />
                                        <InputGroup.Text id='basic-addon2'>
                                            cm
                                        </InputGroup.Text>
                    ...
                    <div className='row-gap-container right-justify-container no-margins-container'>
                        ...
                        <Button className='base-btn' onClick={e => { setFormData(e, 'monsters', { name, national_id, species, description, etymology, avg_weight, avg_height });} }>Create</Button>
                    </div>
