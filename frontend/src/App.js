...
import FacebookOauth from './pages/auth/FacebookOauth';
import GoogleOauth from './pages/auth/GoogleOauth';
import HomePage from './pages/HomePage';
import Login from './pages/auth/Login';
import LoginChange from './pages/auth/LoginChange';
import Register from './pages/auth/Register';
import ResetPasswordConfirm from './pages/auth/ResetPasswordConfirm';
import SetEmailConfirm from './pages/auth/SetEmailConfirm';
import SetUsername from './pages/auth/SetUsername';
import { SetUsernameConfirmation } from './pages/auth/SetUsernameConfirmation';
